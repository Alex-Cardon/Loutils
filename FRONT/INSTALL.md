...
// on installe un outil qui permet de changer de version de node
sudo npm install -g n

// on change de version de node
sudo n lts

// on efface nos dépendances
rm -rf node_modules

// on installe le fichier de log de yarn
rm yarn.lock
...
https://github.com/O-clock-Robin/Soutien-ateliers/issues
